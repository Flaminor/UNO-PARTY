...
def histoire():
    def explications():
        ...
        while (choix3.lower() != "a") or (choix3.lower() != "b"):
            choix3 = input("a)Oui Mr. Santoro    b)Pas vraiment..\nChoix : ")
            if choix3.lower() == "a":
    ...
    time.sleep(1.3)
    print("Je suis Vincent Santoro, le maitre du jeu")
    time.sleep(1.3)
    choix = "b"
    while choix.lower() != "a":
    ...
    if passageniv0 == nom:
        ...
        if passageniv1 == nom:
            ...
            time.sleep(1.3)
            print("Cette fois c'est 3 adversaires et c'est en 2 parties, une seule erreur et c'est fini ahah !")
            time.sleep(1.3)
            print(
